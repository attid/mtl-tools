...
if ((offer_eurmtl_id == 0) or (cost_eur*persent_eurmtl > eurmtl_sale_price*persent_cost) or (cost_eur*persent_eurmtl*persent_cost < eurmtl_sale_price) or (sum_eurmtl != eurmtl_sale_sum)): 
    if (cost_eur < min_price) or (cost_eur > max_price) or (sum_eurmtl < 1):
        pass
    else:
...
if ((offer_xlm_id == 0) or (cost_xlm*persent_xlm > xlm_sale_price*persent_cost) or (cost_xlm*persent_xlm*persent_cost < xlm_sale_price) or (sum_xlm != xlm_sale_sum)): 
