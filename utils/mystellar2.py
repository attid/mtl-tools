...
#
#     cityarr = []
#     mtl_vote = await cmd_gen_mtl_vote_list()
#
#     #################
#     server = Server(horizon_url="https://horizon.stellar.org")
#     response = server.assets().for_code('MTL').for_issuer(public_issuer).limit(200).call()
#
...
#     # get data
#     fund_account = await stellar_get_account(mystellar.public_issuer)
...
#     print(asyncio.run(cmd_get_new_vote_all_mtl('GAD7K44WQSBEKV7Q6MHNLDLVMENDCPGNBL375EFJFPXLEKR7M7IMHYPO', True)))
