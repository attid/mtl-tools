...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("chat_key", sa.BigInteger(), nullable=False),
    ...
    op.create_table(
        "t_ledgers", sa.Column("ledger", sa.BigInteger(), nullable=False), sa.PrimaryKeyConstraint("ledger")
    )
    op.create_table(
        "t_message",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        "t_watch_list", sa.Column("account", sa.String(length=64), nullable=False), sa.PrimaryKeyConstraint("account")
    )
    op.create_table(
        "chat_members",
        sa.Column("chat_id", sa.BigInteger(), nullable=False),
