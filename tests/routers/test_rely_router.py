...
async def test_resolve_command(mock_telegram, router_app_context, mock_grist, grist_server_config, monkeypatch):
    ...
    mock_grist.records["Deals"] = [{"id": 101, "fields": {"Message": expected_deal_url, "Checked": False}}]
    ...
    resolve_notifications = [r for r in requests if r["method"] == "sendMessage" and "#101" in r["data"]["text"]]
